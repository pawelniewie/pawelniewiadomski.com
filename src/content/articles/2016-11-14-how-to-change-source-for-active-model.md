...
date: "2016-11-14"
description: "The nice thing about Active Record scopes is that you not only can specify where conditions. I recently had a need to run a query against a model to..."
tags:
  - rails
  - ruby
  - activerecord
